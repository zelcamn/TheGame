...
Используя кл.Передвижения игрок передаёт игре вектор. Если перед персонажем отсутствует какое-либо <span style="color:blue">препятствие</span>, игра <span style="color:blue">передвигает</span> персонажа по заданному вектору. 
### Боевая система
### Система инвентаря
## Механики
### получение урона
