...
Персонаж может передвигаться в четырёх направлениях. Диагональные направления также разрешены как комбинации основных.\
...
Предметы этого класса могут быть использованы игроком для получения различных эффектов. Например:
1. Восстановление здоровья;
2. Увеличение урона от оружия;
3. Увеличение ПУ или СУ.

Все они хранятся в инвентаре и могут быть использованы игроком в бою.
### Система инвентаря
